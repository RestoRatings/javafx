...
public class ServiceAvis implements IserviceAvis<Avis>{
    ...
    String req = "INSERT INTO avis (dateAvis, pubAvis, titreAvis, id_restau, iduser) VALUES (?, ?, ?, ?, ?)";
    ...
    String req = "UPDATE avis SET dateAvis=?, pubAvis=?, titreAvis=?,id_restau=? WHERE id=?";
...
public List<Avis> recuperer() throws SQLException {
    List<Avis> listeAvis = new ArrayList<>();
      ...
      String req = "SELECT avis.id, avis.dateAvis, avis.pubAvis, avis.titreAvis,restaurant.id_restau, restaurant.nom,user.iduser, user.username FROM avis  INNER JOIN restaurant ON avis.id_restau = restaurant.id_restau INNER JOIN user ON avis.iduser = user.iduser";
    ...
    while (rs.next()) {
        ...
        restaurant.setId(rs.getInt("id_restau"));
...
///////////////////////////rechercheParNomDeResto/////////////////////////////
    ...
    public List<Avis> getAvisByUsernameAndRestaurant(String username, String nomRestaurant) throws SQLException {
        String query = "SELECT * FROM avis WHERE iduser = (SELECT iduser FROM user WHERE username = ?) "
                     + "AND id_restau = (SELECT id_restau FROM restaurant WHERE nom = ?)";
...
public List<Avis> getAvisByRestaurantName(String nomRestaurant) throws SQLException {
    String query = "SELECT * FROM avis WHERE id_restau = (SELECT id_restau FROM restaurant WHERE nom = ?)";
   ...
   private Avis createAvisFromResultSet(ResultSet resultSet) throws SQLException {
    ...
    int restaurantId = resultSet.getInt("id_restau");
