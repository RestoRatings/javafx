...
public void ajouter(Badge ba, Restaurant rs, User us) throws SQLException {
    ...
    String req = "INSERT INTO badge (commantaire, dateBadge, typeBadge, iduser,id_restau) VALUES (?, ?, ?, ?,?)";
    ...
    String req1 = "INSERT INTO badge_restaurant (id_restau, idbadge) VALUES (?, ?)";
...
public void modifier(int id, Badge badgeModifie, int idr) throws SQLException {
    ...
    String req = "UPDATE `badge` SET `commantaire` = ?, `dateBadge` = ?, `typeBadge` = ?, `id_restau` = ? WHERE `id` = ?";
    PreparedStatement ps = connection.prepareStatement(req);
   ...
   public List<Badge> recuperer() throws SQLException {
    List<Badge> listeBadge = new ArrayList<>();
     ...
     String req = "SELECT badge.id, badge.dateBadge, badge.commantaire, badge.typeBadge, " +
             "restaurant.id_restau, restaurant.nom, user.username, user.iduser " +
             "FROM badge " +
             "INNER JOIN restaurant ON badge.id_restau = restaurant.id_restau " + 
  ...
  public Badge obtenirBadgeParIdUser(int userId) throws SQLException {
    ...
    try {
        String sql = "SELECT b.*, r.nom " +
                     "FROM badge b " +
                     "JOIN restaurant r ON b.id_restau = r.id_restau " +
                     "WHERE b.iduser = ?";
  ...
  public boolean badgeExistePourRestaurant(TypeBadge typeBadge, int idRestaurant) throws SQLException {
    String req = "SELECT id FROM badge WHERE typeBadge = ? AND id_restau = ?";
    PreparedStatement ps = connection.prepareStatement(req);
